            ...
            <tbody className="divide-y divide-slate-100/50">
              {earningsData?.history?.map((item: any, idx: number) => (
                <tr key={idx} className={`transition-colors ${item.status === 'Disputed' ? 'bg-red-50/30' : 'hover:bg-slate-50/50'}`}>
                  ...
                  <td className="px-6 py-4 text-indigo-600 font-bold">{item.total} €</td>
                  <td className="px-6 py-4">
                    ...
                    <div className="flex items-center justify-end gap-2">
                      {item.status === 'Disputed' && (
                        <button
                          ...
                          className="p-2 bg-indigo-50 text-indigo-600 hover:bg-indigo-100 rounded-lg transition-colors flex items-center justify-center text-sm font-medium gap-1"
                        >
            ...
            >
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-xl font-bold text-slate-900 flex items-center gap-2">
                  <FileEdit className="text-indigo-600" /> Zeiten korrigieren
                </h3>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full border-slate-200 rounded-xl p-2 bg-white/50 focus:ring-2 focus:ring-indigo-500"
                    />
                  </div>
                  <div>
              ...
              <div className="mt-6 flex justify-end gap-3">
                ...
                <button
                  ...
                  className="px-4 py-2 text-white bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 rounded-xl transition-colors font-medium flex items-center gap-2"
                >
