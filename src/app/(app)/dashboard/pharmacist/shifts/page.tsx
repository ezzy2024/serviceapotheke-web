                ...
                <div className="p-6 md:w-2/3 border-b md:border-b-0 md:border-r border-slate-100">
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <span className={`inline-flex px-3 py-1 rounded-full text-xs font-bold ${
                      shift.status === 'Accepted' ? 'bg-indigo-100 text-indigo-700' :
                  ...
                  {shift.status === 'Accepted' && (
                    <>
                      ...
                      <button 
                        ...
                        className="w-full py-2.5 px-4 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-xl transition-colors shadow-sm"
                      >
                        Schicht abschließen
                      </button>
                    </>
