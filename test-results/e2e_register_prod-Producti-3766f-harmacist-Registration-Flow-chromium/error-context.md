...
```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/register/pharmacist
Call log:
  - navigating to "http://localhost:3000/register/pharmacist", waiting until "load"
